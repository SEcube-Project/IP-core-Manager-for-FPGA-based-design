...
-- Module  Version: 7.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n buf_mem -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type bram -wp 11 -rp 1010 -data_width 16 -rdata_width 16 -num_rows 64 -cascade -1 -mem_init0 -writemodeA NORMAL -writemodeB NORMAL 

-- Sun Sep 26 22:36:36 2021
...
architecture Structure of buf_mem is
    ...
    attribute MEM_LPC_FILE of buf_mem_0_0_1 : label is "buf_mem.lpc";
    attribute MEM_INIT_FILE of buf_mem_0_0_1 : label is "INIT_ALL_0s";
    attribute MEM_LPC_FILE of buf_mem_0_1_0 : label is "buf_mem.lpc";
    attribute MEM_INIT_FILE of buf_mem_0_1_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of buf_mem is
    for Structure
